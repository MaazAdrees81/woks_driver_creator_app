...
class NotificationItemWidget extends StatelessWidget {
  ...
  NotificationItemWidget({Key key, this.onMarkAsRead, this.onMarkAsUnRead, this.onRemoved}) : super(key: key);
  @override
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    ...
                    style: Theme.of(context).textTheme.bodyText1.merge(TextStyle(fontWeight: FontWeight.w600)),
                  ),
                  Text(
                    '20-2-20',
