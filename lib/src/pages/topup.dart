...
import 'package:products_deliveryboy/src/components/light_color.dart';
import 'package:products_deliveryboy/src/components/title_text.dart';
import 'package:products_deliveryboy/src/controllers/wallet_controller.dart';
    ...
    return InkWell(
      onTap: (){
        if(currentUser.value.walletAmount!='0') {
          ...
          if(int.parse(currentUser.value.walletAmount)>double.parse(textEditingController.text)) {
            _con.recharge(textEditingController.text);
          } else{
           _con.showToast("Low balance");
          }
        } else{
          _con.showToast("Your wallet balance is 0");
        }
