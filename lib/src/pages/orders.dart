  ...
  Widget build(BuildContext context) {
    ...
    return   ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return  course['status']=='Shipped'||course['status']=='RShipped'?Theme(
                        data: theme,
                        child:InkWell(
                          onTap: () {
                                            ...
                                            children: [
                                              Wrap(
                                                children:[
                                                  Container(
                                                    ...
                                                    child: ClipOval(
                                                      child: CachedNetworkImage(
                                                        imageUrl: "${GlobalConfiguration().getString('base_upload')}uploads/vendor_image/vendor_${course['shopId']}.png",
                                                  ...
                                                  course['driverStatus']=='Start' || course['driverStatus']=='Pickuped' ? Container(
                                              ...
                                              Column(
                                                  ...
                                                  children:[
                                                    Container(
                                                      padding: EdgeInsets.only(left:15,right:15, top: 20),
                                                      child: Text('#${course['orderId']}', style: Theme.of(context).textTheme.headline3),
                                                    ),
                                                    Container(
                                                      padding: EdgeInsets.only(left:15,right:15,),
                                                      child: Text(timeago.format(DateTime.fromMillisecondsSinceEpoch(course['DriverATime'])), style: Theme.of(context).textTheme.caption.merge(TextStyle(color:Theme.of(context).primaryColorDark,fontWeight: FontWeight.w600))),
                                                    ),
                                                  ]
                                              ),
                                          ...
                                          Container(
                                              ...
                                              child:Column(
                                                  ...
                                                  children:[
                                                      ...
                                                      children:[
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Badge(
                                                            ...
                                                            badgeContent: Text(course['status'],
                                                              style: Theme.of(context).textTheme.caption.merge(TextStyle(color:Theme.of(context).primaryColorLight,height:1.2)),
                                                            ),
                                                          ),
                                                        ),
                                                      ]
                                                    ...
                                                    Container(
                                                        child:Text('${course['ShopAddress']}',style:Theme.of(context).textTheme.caption)
                                                    ),

                                                    Container(
                                                        child:Text(course['driverStatus'],
