    ...
    return Scaffold(
      appBar: AppBar(
        leading: new IconButton(
          icon: new Icon(Icons.arrow_back_outlined, color: Theme.of(context).hintColor),
          ...
          children: <Widget>[
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                OrderHistoryModel _orderTrack = _con.orders.elementAt(index);
                return InkWell(
                  onTap: () {

                    Navigator.of(context).pushNamed('/OrderDetails',arguments: _orderTrack.id);
                  },
                  child: Container(
                    child: Row(
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Row(
                                    ...
                                    children: [
                                      Wrap(
                                        children:[
                                          Container(  padding: EdgeInsets.only(left:15,right:15, top: 20),
                                            child: Container(
                                              width: 50.0,
                                              height: 50.0,
                                              ...
                                              decoration: new BoxDecoration(
                                                ...
                                                image: new DecorationImage(
                                                  fit: BoxFit.fill,
                                                  image: NetworkImage('${GlobalConfiguration().getString('base_upload')}uploads/vendor_image/vendor_${_orderTrack.vendorId}.png'),
                                                ),
                                              ),
                                            ),
                                          ...
                                          Container(
                                              ...
                                              child:Image(image:AssetImage('assets/img/processing.gif'),
                                                  width:20,height:20
                                              )
                                          ),
                                        ]
                                      ...
                                      Column(
                                          ...
                                          children:[
                                            Container(
                                              ...
                                              child: Text(' #${_orderTrack.id}', style: Theme.of(context).textTheme.headline3),
                                            ),
                                            Container(
                                              padding: EdgeInsets.only(left:15,right:15,),
                                              child: Text(timeago.format(DateTime.fromMillisecondsSinceEpoch(int.parse(_orderTrack.date)*1000)), style: Theme.of(context).textTheme.caption.merge(TextStyle(color:Theme.of(context).primaryColorDark,fontWeight: FontWeight.w600))),
                                            ),
                                          ...
                                          children:[
                                            Row(
                                              ...
                                              children:[
                                                Expanded(
                                                  child:Container(
                                                      child:Text(_orderTrack.shopName,
                                                ...
                                                Container(
                                                  ...
                                                  child: Badge(
                                                    ...
                                                    badgeColor: _orderTrack.status=='Delivered'? Colors.green:Colors.deepOrange,
                                                    borderRadius: BorderRadius.circular(8),
                                                    badgeContent: Text(_orderTrack.status,  style: Theme.of(context).textTheme.caption.merge(TextStyle(color:Theme.of(context).primaryColorLight,height:1.2)),
                                                    ),
                                                  ),
                                                ),
                                              ]
                                            ...
                                            Container(
                                                child:Text(_orderTrack.shopAddress,style:Theme.of(context).textTheme.caption)
                                            ),
                                  ...
                                  Container(
                                    padding: EdgeInsets.only(left: 15, bottom: 10,right:15, top: 5),
                                    child:Wrap(
                                              ...
                                              child:Row(
                                                  ...
                                                  children:[
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Icon(Icons.circle,color:Theme.of(context).primaryColorDark,size:15),
                                                    ),
                                            ...
                                            Div(
                                              ...
                                              child: Container(
                                                  ...
                                                  child:Wrap(
                                                      children:[
                                                        RichText(
                                                          text: new TextSpan(text: Helper.pricePrint(_orderTrack.amount),
                                              ...
                                              InkWell(
                                                ...
                                                child: Container(
                                                    ...
                                                    child:Text('View Details',
                                                      style: Theme.of(context).textTheme.subtitle2.merge(TextStyle(color:Colors.orange)),
                                                    )
                                                ),
                                              ),
                                            )
