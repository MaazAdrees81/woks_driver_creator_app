...
class OtpVerificationEmail extends StatefulWidget {
  ...
  OtpVerificationEmail({
    Key key,this.email, this.otp, this.con
  }) : super(key: key);
...
class _OtpVerificationEmailState extends StateMVC<OtpVerificationEmail> with TickerProviderStateMixin {
        ...
        child: Form(
          child: Column(
            ...
            children: <Widget>[
                          ...
                          child: OTPTextField(
                            ...
                            onCompleted: (pin) {
                              ...
                              if(widget.con.otpNumber == pin){
                                Navigator.of(context).pushNamed('/NewPassword', arguments: widget.email );
                              } else {
              ...
              RaisedButton(
                onPressed: () {
                  if(widget.con.otpNumber ==    optPin ){
                    Navigator.of(context).pushNamed('/NewPassword', arguments: widget.email );
                  } else {
                    Fluttertoast.showToast(
                      msg: "Password is not matched",
