...
class _MapWidgetState extends StateMVC<MapWidget> {
  ...
  getTrackDetails() {
    LatLng _destination;
    LatLng _driver ;
    FirebaseFirestore.instance.collection("orderDetails").where("orderId", isEqualTo: widget.orderDetails.sale_code).snapshots().listen((snapshot) {
      snapshot.docs.forEach((result) {

        if(result.data()["status"]=='RShipped' ){
          _destination = LatLng(result.data()["shopLatitude"], result.data()["shopLongitude"]);
      } else {
          _destination = LatLng(result.data()["originLatitude"], result.data()["originLongitude"]);
        }

        _driver = LatLng(result.data()["driverLatitude"], result.data()["driverLongitude"]);
      ...
      child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              widget.orderDetails.delivery_state=='Start'?Container(
          ...
          child: Row(
            children: [
              InkWell(
               onTap:(){
                 _con.openMap(widget.orderDetails.shop.latitude, widget.orderDetails.shop.longitude);
                },
                child: Column(
                  children: [
                    Padding(
                ...
                badgeContent: Container(
          ...
          )): widget.orderDetails.delivery_state=='Pickuped'?Container(
                  padding: EdgeInsets.only(left: 18, right: 18, bottom: 18),
                  color: Theme
                      .of(context)
                      .primaryColor,
                  child: Row(
                    children: [
                      InkWell(
                        onTap:(){
                          _con.openMap(widget.orderDetails.address.latitude, widget.orderDetails.address.longitude);
                        },
                        child: Column(
                          children: [
                            Padding(
                      ...
                      Badge(
                        ...
                        badgeContent: Container(
                          ...
                          child:InkWell(
                            onTap: (){
                              _callNumber(widget.orderDetails.address.phone);
                            },
                            child:Center(
                              child:Icon(Icons.call, color: Colors.white,),
                            ),
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text('Bill Details', style: Theme.of(context).textTheme.bodyText1),
                    SizedBox(height: 10),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text('Payment Model', style: Theme.of(context).textTheme.subtitle2),
                        Text(widget.orderDetails.payment_type, style: Theme.of(context).textTheme.subtitle2),
                      ],
                    ),
                    SizedBox(height: 5),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Spacer(),
                          Text(
                            Helper.pricePrint(widget.orderDetails.grand_total),
                            style: Theme.of(context).textTheme.bodyText1,
                          ),
                        ],
                      ),
      ...
      child:Scaffold(
        floatingActionButton: Container(
            ...
            child: Container(
                ...
                child:  widget.orderDetails.delivery_state != 'Delivered'?Center(
                  child: Card(
                    elevation: 5,
                    shape: StadiumBorder(),
                    ...
                    child: FlatButton(
                        onPressed: () {
                          if( widget.orderDetails.delivery_state =='Start') {
                            _con.statusUpdate('Pickuped', widget.orderDetails.sale_code, '');
                            setState(() {
                              widget.orderDetails.delivery_state = 'Pickuped';
                            });
                          } else {
                            _con.statusUpdate('Delivered', widget.orderDetails.sale_code, '');
                            setState(() {
                      ...
                      color: Theme.of(context).accentColor,
                        shape: StadiumBorder(),
                        child: widget.orderDetails.delivery_state =='Start'?Text(
                          'Pickuped',
                          style: Theme.of(context)
                              .textTheme
                              .caption
                              .merge(TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                        ):widget.orderDetails.delivery_state =='Pickuped'?Text(
                          'Delivered',
                          style: Theme.of(context)
                              .textTheme
                              .caption
                      ...
                      children: [
                        ...
                        _info == null
                            ...
                            style: Theme.of(context)
                                .textTheme
                                .subtitle2
                                .merge(TextStyle(color: Theme.of(context).scaffoldBackgroundColor, fontWeight: FontWeight.w600)))
