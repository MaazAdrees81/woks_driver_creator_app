                                    ...
                                    child:Container(
                                        ...
                                        child:Stack(
                                            children:[
                                              ...
                                              Positioned(
                                                bottom:110,left: size.width < 769 ? size.width *0.05 :size.width * 0.08,
                                                child:Align(
                                                            ...
                                                            child: Wrap(
                                                                children:[
                                                                  ...
                                                                  Container(
                                                                      ...
                                                                      child:Text(_con.dashboardData.rating,style: TextStyle(color:Theme.of(context).primaryColorLight),)
                                                                  ),
                                                                ]
                                                            )
                                                          ),
                                                      ...
                                                      children:[
                                                        ...
                                                        Container(
                                                          child: Column(
                                                              ...
                                                              children:[
                                                                Container(
                                                                    child:Text(Helper.pricePrint(_con.dashboardData.lastSDaysEarn),
